...
Imports System.IO
Public Class Search_attendence_teacher
    ...
    Private Sub Refresh_data()
        ...
        End If
        Dim da As New OleDb.OleDbDataAdapter("select ID,FAC_NAME,YEAR,DIV,PRACTICAL_NAME,DATE,LOGIN_TIME,LOGOUT_TIME from Teacher_Table", cnn)
    ...
    End Sub
    Private Sub Search_attendence_teacher_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        ...
        Else
            ...
            End If
            Dim da As New OleDb.OleDbDataAdapter("select ID,FAC_NAME,YEAR,DIV,PRACTICAL_NAME,DATE,LOGIN_TIME,LOGOUT_TIME from Teacher_Table where DATE= '" & TextBox1.Text & "' ", cnn)
            Dim dt As New DataTable
            da.Fill(dt)
            Me.DataGridView1.DataSource = dt
            cnn.Close()
    ...
    Private Sub TextBox2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox2.TextChanged
        ...
        Else
            ...
            End If
            Dim da As New OleDb.OleDbDataAdapter("select ID,FAC_NAME,YEAR,DIV,PRACTICAL_NAME,DATE,LOGIN_TIME,LOGOUT_TIME from Teacher_Table where   FAC_NAME= '" & TextBox2.Text & "' ", cnn)
            Dim dt As New DataTable
            da.Fill(dt)
            Me.DataGridView1.DataSource = dt
            cnn.Close()
    ...
    Private Sub TextBox3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox3.TextChanged
        ...
        Else
            ...
            End If
            Dim da As New OleDb.OleDbDataAdapter("select ID,FAC_NAME,YEAR,DIV,PRACTICAL_NAME,DATE,LOGIN_TIME,LOGOUT_TIME from Teacher_Table where ID= " & TextBox3.Text & " ", cnn)
            Dim dt As New DataTable
            da.Fill(dt)
            Me.DataGridView1.DataSource = dt
            cnn.Close()
    ...
    Private Sub TextBox4_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox4.KeyUp
        ...
        Else
            ...
            End If
            Dim da As New OleDb.OleDbDataAdapter("select ID,FAC_NAME,YEAR,DIV,PRACTICAL_NAME,DATE,LOGIN_TIME,LOGOUT_TIME from Teacher_Table where PRACTICAL_NAME= '" & TextBox4.Text & "' ", cnn)
            Dim dt As New DataTable
            da.Fill(dt)
            Me.DataGridView1.DataSource = dt
            cnn.Close()
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If SaveFileDialog1.ShowDialog = DialogResult.OK Then
            ...
            If Windows.Forms.DialogResult.OK Then
                ...
                Dim PdfFile As New Document(PageSize.A4, 80, 80, 80, 40) ' set pdf page size
                ...
                Dim pTitle As New Font(iTextSharp.text.Font.FontFamily.TIMES_ROMAN, 12, iTextSharp.text.Font.BOLD, BaseColor.BLACK)
